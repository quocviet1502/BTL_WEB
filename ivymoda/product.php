...
?>
 ...
 <section class="product">
    ...
    if (isset($_GET['sanpham_id']) && $_GET['sanpham_id'] != NULL) {
        ...
        <input type="submit" class="btn btn-primary" value="Gửi bình luận" name="feedback_submit" style="background-color: #007BFF; color: #fff; border: none; padding: 10px 20px; cursor: pointer;">
        </form>
